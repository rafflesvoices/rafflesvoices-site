...
<div>
	<h1 class="text-4xl md:text-9xl pb-5 pl-14 text-white font-pt-serif font-bold">Raffles Voices</h1>
...
<div class="w-11/12">
	<h2 class="text-3xl md:text-5xl pt-10 md:pt-32 pb-4 pl-14 text-blue-400 font-canela-serif italic">Who are we?</h2>
