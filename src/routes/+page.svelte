<script lang="js">
	import heading from '$lib/assets/img/header.webp';
...
<div>
	<h1 class="text-4xl md:text-9xl pb-5 pl-14 text-white font-pt-serif font-bold" id="title">Raffles <span class="text-rv-special">Voices</span></h1>
